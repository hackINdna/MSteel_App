...
class _FactoryRateScreenState extends State<FactoryRateScreen> {
  ...
  //   MapModel(name: "ArunachalPradesh", disp: "Arunachal Pradesh"),
  //   MapModel(name: "Assam", disp: "Assam"),
  //   MapModel(name: "Bihar", disp: "Bihar"),
  //   MapModel(name: "Chandigarh", disp: "Chandigarh"),
  //   MapModel(name: "Chhattisgarh", disp: "Chhattisgarh"),
  //   MapModel(name: "DadraandNagarHaveli", disp: "Dadra And\nNagar Haveli"),
  //   MapModel(name: "DamanandDiu", disp: "Daman And Diu"),
  //   MapModel(name: "Goa", disp: "Goa"),
  //   MapModel(name: "Gujarat", disp: "Gujarat"),
  //   MapModel(name: "Haryana", disp: "Haryana"),
  //   MapModel(name: "HimachalPradesh", disp: "HimachalPradesh"),
  //   MapModel(name: "JammuandKashmir", disp: "Jammu &\nKashmir"),
  //   MapModel(name: "Jharkhand", disp: "Jharkhand"),
  //   MapModel(name: "Karnataka", disp: "Karnataka"),
  //   MapModel(name: "Kerala", disp: "Kerala"),
  //   MapModel(name: "Lakshadweep", disp: "Lakshadweep"),
  //   MapModel(name: "MadhyaPradesh", disp: "Madhya Pradesh"),
  //   MapModel(name: "Maharashtra", disp: "Maharashtra"),
  //   MapModel(name: "Manipur", disp: "Manipur"),
  //   MapModel(name: "Meghalaya", disp: "Meghalaya"),
  //   MapModel(name: "Mizoram", disp: "Mizoram"),
  //   MapModel(name: "Nagaland", disp: "Nagaland"),
  //   MapModel(name: "NCTofDelhi", disp: "Delhi"),
  //   MapModel(name: "Odisha", disp: "Odisha"),
  //   MapModel(name: "Puducherry", disp: "Puducherry"),
  //   MapModel(name: "Punjab", disp: "Punjab"),
  //   MapModel(name: "Rajasthan", disp: "Rajasthan"),
  //   MapModel(name: "Sikkim", disp: "Sikkim"),
  //   MapModel(name: "TamilNadu", disp: "Tamil Nadu"),
  //   MapModel(name: "Telangana", disp: "Telangana"),
  //   MapModel(name: "Tripura", disp: "Tripura"),
  //   MapModel(name: "UttarPradesh", disp: "Uttar Pradesh"),
  //   MapModel(name: "Uttarakhand", disp: "Uttarakhand"),
  //   MapModel(name: "WestBengal", disp: "West Bengal"),
  // ];
  final List<MapModel> _stateData = [
    ...
    MapModel(name: "Delhi", disp: "Delhi"),
    MapModel(name: "Haryana", disp: "Haryana"),
    MapModel(name: "Jharkhand", disp: "Jharkhand"),
    MapModel(name: "Karnataka", disp: "Karnataka"),
    MapModel(name: "Kerala", disp: "Kerala"),
    ...
    MapModel(name: "Gujarat", disp: "Gujarat"),
    MapModel(name: "Uttarakhand", disp: "Uttarakhand"),
    MapModel(name: "Uttar Pradesh", disp: "Uttar Pradesh"),
    MapModel(name: "Sikkim", disp: "Sikkim"),
    MapModel(name: "Assam", disp: "Assam"),
    MapModel(name: "Arunachal Pradesh", disp: "Arunachal Pradesh"),
    MapModel(name: "Nagaland", disp: "Nagaland"),
    MapModel(name: "Manipur", disp: "Manipur"),
    MapModel(name: "Mizoram", disp: "Mizoram"),
    MapModel(name: "Tripura", disp: "Tripura"),
    MapModel(name: "Meghalaya", disp: "Meghalaya"),
    MapModel(name: "Bihar", disp: "Bihar"),
    MapModel(name: "Ladakh", disp: "Ladakh"),
    MapModel(name: "Jammu and Kashmir", disp: "Jammu and Kashmir"),
    MapModel(name: "Odisha", disp: "Odisha"),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    //     "GID_0": "Z07",
    //     "COUNTRY": "India",
    //     "NAME_1": "ArunachalPradesh",
    //     "VARNAME_1": "AgencedelaFrontièreduNord-E",
    //     "NL_NAME_1": "NA",
    //     "TYPE_1": "State",
    //     "ENGTYPE_1": "State",
    //     "CC_1": "NA",
